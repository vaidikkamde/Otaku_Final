...
function Privacy() {
  return (
    <>
      ...
      <p>
        At OTAKU, accessible from https://otakuorg.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by OTAKU
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in OTAKU. This policy is not applicable to any
      ...
      <p>
        OTAKU follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of OTAKU.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on OTAKU, which are sent directly
      ...
      <p>
        Note that OTAKU has no access to or control over these cookies that are
      ...
      <p>
        OTAKU's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        OTAKU does not knowingly collect any Personal Identifiable Information
